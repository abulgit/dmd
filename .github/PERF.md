...
host compiler ldc-1.42.0, a PGO profile trained on each commit's own testsuite, and LTO, the same way a release is built.
So any difference in the numbers comes from the PR itself.
